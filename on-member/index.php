...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
        ...
        <div id="slides" class="carousel slide" data-ride="carousel" data-interval="7000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active" style="background-image:url(../assets/img/jumbo.jpg);">
                ...
                <div class="carousel-item" style="background-image:url(../assets/img/bg-login.jpg);"></div>
                <div class="carousel-item" style="background-image:url(../assets/img/login.jpg);"></div>
    ...
    <div class="row jumbotron welcome">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
            <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic recusandae nisi aliquid nesciunt quia, nihil! Sit perspiciatis illo blanditiis eligendi amet similique itaque nemo delectus nisi! Praesentium atque magnam laboriosam.</p>
        </div>
        <!-- </div> -->
                        ...
                        <div class="col text-center">
                            <div class="kategori">
                                <ul class="clearfix button-group filters-button-groups">
                                    ...
                                    <li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center active is-checked" data-filter="*">Minuman</li>
                                    <li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center active is-checked" data-filter="*">Makanan</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 development">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <img src="../foto_profil/fotoProfil.jpeg" alt="">
                                </div>
                                <div class="col-md-6">
                                    <blockquote>
                                        <i class="fas fa-quote-left"></i>
                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eligendi, est ut, nisi sequi reprehenderit dolorum aspernatur dicta aut cupiditate iure molestias hic animi consequuntur ex? Obcaecati dolor tenetur tempore aliquam.
                                        <hr class="my-2">
                                        <cite>&#8212; Student</cite>
                                    </blockquote>
                                </div>
                        ...
                        <div class="col-md-6 website">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <blockquote>
                                        <i class="fas fa-quote-left"></i>
                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maiores ea laudantium possimus minus qui molestiae ducimus! Aspernatur quasi reiciendis incidunt voluptates tempore sunt soluta, eos repellat exercitationem ullam vero quaerat!
                                        <hr class="my-2">
                                        <cite>&#8212; PK</cite>
                                    </blockquote>
                                </div>
            ...
            <div class="container mt-5">
                            ...
                            <div class="block-23 mb-3">
                                <ul class="list-unstyled" id="address">
                                    <li class="pb-4">
                                        ...
                                        <span class="text ml-3">City State, New York</span>
                                    </li>
                                    <li class="pb-4">
                ...
                <div class="row">
                    <div class="col-md-12 text-center mt-2">
                        <p>
                            &copy;Copyright Imamah Shop with Bootstrap 4 theme 2019
